...
from light_req import VehicleLightingSystem, parse_message_catalog, analyze_lights, monitor_json_file
...
class CANLightMaster:
    ...
    def initialize_analysis_file(self):
        ...
        light_status = parse_message_catalog(self.json_filename)
    ...
    def monitor_json_file(self):
        """Monitor the JSON file for changes using the imported function"""
        monitor_json_file(self.json_filename)
...
if __name__ == "__main__":
    ...
    # Start thread for monitoring JSON file
