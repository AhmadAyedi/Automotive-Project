...
std::string DoorsClient::get_current_timestamp() {
...
void DoorsClient::front_right_door(const std::string &state) {
    std::string message = get_current_timestamp() + " Front Right Door | " + state;
    std::cout << message << std::endl;
}

void DoorsClient::rear_right_door(const std::string &state) {
    std::string message = get_current_timestamp() + " Rear Right Door | " + state;
    std::cout << message << std::endl;
}

void DoorsClient::front_left_door(const std::string &state) {
    std::string message = get_current_timestamp() + " Front Left Door | " + state;
    std::cout << message << std::endl;
}

void DoorsClient::rear_left_door(const std::string &state) {
    std::string message = get_current_timestamp() + " Rear Left Door | " + state;
    std::cout << message << std::endl;
}

void DoorsClient::key_door(const std::string &state) {
    std::string message = get_current_timestamp() + " Key | " + state;
    std::cout << message << std::endl;
}
