...
class CANLightMaster:
    ...
    def write_response_to_file(self, signals):
        """Write response signals to light_response_signals.txt, simplified_results.txt, and MySQL database"""
        ...
        try:
            ...
            print(f"Response signals written to MySQL database at {timestamp}")
        except Error as e:
            print(f"Error writing to MySQL database: {e}")
